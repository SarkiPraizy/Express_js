...
const dataPath = path.join("C:", "Users","DELL", "Desktop", "Expressjs_routing", "db", "items.json")


// Getting all items with the GET method//
...
// Getting only one item using the GET method//
...
// Creating Item with the POST method //
...
// Updating item with the PATCH/PUT method//
...
module.exports = {getAll, getOneItem, createItem, updateItem, deleteItem,
};